    ...
    <div className="w-screen">
        <div className="w-full max-w-6xl m-auto py-8">
            ...
            <div className="flex items-center justify-between space-x-10">
                <Link to={'/products/categories/shoes'} className="text-center border-[1px] rounded">
                    <img src="/category-graduation.png" alt="" className="rounded-t" />
                    <p className="p-3">Shoes</p>
                </Link>
                <Link to={'/products/categories/clothing'} className="text-center border-[1px] rounded">
                    <img src="/category-furniture.png" alt="" className="rounded-t" />
                    <p className="p-3">Clothing</p>
                </Link>
                <Link to={'/products/categories/accessories'} className="text-center border-[1px] rounded">
                    <img src="/category-school.png" alt="" className="rounded-t" />
                    <p className="p-3">Accessories</p>
                </Link>
                <Link to={'/products/categories/food'} className="text-center border-[1px] rounded">
